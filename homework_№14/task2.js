...
newForm.sign_up.addEventListener('click', function() {
  if(newForm.check.checked) {
     ...
     userBio.classList.add('second_page');
       if(userMan.checked == false ) userIcon.classList.add('portrait_woman');
       else if(userWoman.checked  == false) userIcon.classList.add('portrait_man'); 
...
bottomBtn.addEventListener('click', function(){
  ...
  userIcon.classList.remove('portrait_woman');
  userIcon.classList.remove('portrait_man');
  userBio.classList.remove('second_page');
  userBio.classList.add('non-visible');
  newForm.reset();
